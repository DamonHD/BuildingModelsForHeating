...
class WeatherCompHeatPumpController(EnergyPlusPlugin):
    ...
    def __init__(self):
        ...
        # Eg for LC AAAA flow temp at external: 30.9C@15C, 46.3C@-3C, 43.8C@0C
        # slope = (46.3-30.9)/(-3-15) = -0.856, intercept = 43.8C
        #
        # DHD20260323: DE values self.wc_slope = -1.19; self.wc_intercept = 46.0
        #
        # DHD20260331: bungalow-2 RAD_UA_FACTOR=30.50 LC AAAA flow@ext: 46.0@-3, 43.6@0, 30.8@15: i=43.6, s=-0.844
        self.wc_slope = -0.844
