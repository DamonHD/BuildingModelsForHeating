...
def load_file(name, file):
    renamer = {
        ...
        "Z1:Zone Operative Temperature [C](Hourly)": "z1:operative_temp_c",
        "Z2:Zone Operative Temperature [C](Hourly)": "z2:operative_temp_c",
        "Z3:Zone Operative Temperature [C](Hourly)": "z3:operative_temp_c",
        "Z4:Zone Operative Temperature [C](Hourly)": "z4:operative_temp_c",
