...
class WeatherCompHeatPumpController(EnergyPlusPlugin):
    ...
    def __init__(self):
        ...
        # Variables as of v0.1.2 w/ wall as roof and Simple/SimpleCombined convection
        # self.wc_slope = -1.19
        # self.wc_intercept = 46.0
        # DE20260115: w/ new roof, TARP and operative temperature control
        # LC-AAAA flow temp @ -3 C: 51.36 C
        # LC-AAAA flow temp @ 15 C: 31.68 C
        self.wc_slope = -1.09
        self.wc_intercept = 48.0
        # DE20260115: w/ new roof, Simple/SimpleCombined and operative temperature control
        # LC-AAAA flow temp @ -3 C: 50.03 C
        # LC-AAAA flow temp @ 15 C: 28.23 C
        # self.wc_slope = -1.21
        # self.wc_intercept = 46.4
